...
## In-Depth Analysis of Product Sales by Christopher Hunt
...
Source: [Big Mart Sales Prediction - Analytics Vidhya](https://datahack.analyticsvidhya.com/contest/practice-problem-big-mart-sales-iii/)

The dataset comprises 8523 rows and 12 columns.

### Data Dictionary
![Data Dictionary](https://github.com/chrishunt11/Prediction-of-Product-Sales/assets/123383359/06c0f6b5-b1be-4a6d-8712-6cff3262a07c)

### Data Preparation and Exploratory Data Analysis

#### Exploratory Data Analysis
- Visualizations such as histograms and box plots were employed for key parameters.
- Count plots were used to visualize the distribution of Outlet location and type.
...
1. Linear Regression Model (Testing Set):
   - R^2 = 0.570
   - MAE = 802.048
   - MSE = 1,186,964.271
   - RMSE = 1,089.479

2. Bagged Tree Regressor Model (Testing Set):
   - R^2 = 0.526
   - MAE = 795.198
   - MSE = 1,306,771.261
   - RMSE = 1,143.141

3. Tuned Bagged Tree Regressor Model (Testing Set):
   - R^2 = 0.578
   - MAE = 756.837
   - MSE = 1,163,912.604
   - RMSE = 1,078.848 
...
5. Tuned Random Forest Model (Testing Set):
   - R^2 = 0.595
   - MAE = 736.676
   - MSE = 1,116,454.429
   - RMSE = 1,056.624
